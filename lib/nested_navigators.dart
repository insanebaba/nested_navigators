...
class NestedNavigators<T> extends StatefulWidget {
  NestedNavigators(
      ...
      this.injectedBottomNavigationBar})
  ...
  final InjectedBottomNavigationBar injectedBottomNavigationBar;
...
class _NestedNavigatorsState<T> extends State<NestedNavigators> {
  ...
  Widget _buildNativeBottomNavigatorBar() => widget.injectedBottomNavigationBar !=
          null
      ? widget.injectedBottomNavigationBar(
